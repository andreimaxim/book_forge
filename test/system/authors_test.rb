...
class AuthorsSystemTest < ApplicationSystemTestCase
  ...
  test "creating a new author" do
    ...
    # Should show flash and update the list
  ...
  test "editing an author inline" do
    ...
    # Click edit button on show page (use first match to target the author Edit link)
    click_link "Edit", match: :first

    assert_selector "h2", text: "Edit Author"

    # Update the bio
    fill_in "Bio", with: "Updated bio: English novelist known for romantic fiction and social commentary."
    click_button "Update Author"

    # Should update inline and show the updated content
